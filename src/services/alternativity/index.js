...
const defaultMockSubjets = [{ "name": "Administracion Gerencial", "shortName": "T", "color": "#69b717", "schedules": [{ "days": [{ "name": "Lu", "turn": "n", "startHour": 1, "endHour": 5 }], "active": true }, { "days": [{ "name": "Mi", "turn": "n", "startHour": 1, "endHour": 5 }], "active": false }], "isOptional": false, "errorLog": "" },
...
export const generateAlternatives = (subjects = defaultMockSubjets) => {
  ...
  return inscription.alternativities;
}